...
<body>
        ...
        <div class="card text-center">
            ...
            ?>
                ...
                <div class="card-footer">
                    <p>Posté le : <?= htmlspecialchars($article['createdAt']); ?></p>
                </div>
            <?php
            }
            ?>
    ...
    <section id="paysage">
        <div class="wrapper">
            <div class="content">
                <h2 class="h1" role="complementary">"Découvrez une autre façon de manger des burgers..."</h2>
                <p class="blockquote-footer" role="complementary">Manger c'est sacré, ne pas manger c'est pêcher... <cite title="Source Title">Best B.</cite></p>
            </div>
        </div>
    </section>
    <!-- inclusion du footer -->
